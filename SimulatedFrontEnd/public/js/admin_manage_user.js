    ...
    $('#submitButton').on('click', function (event) {
        ...
        axios({
            ...
            .then(function (response) {
                ...
                // console.dir(response.data.data[0].userdata);
                const records = response.data.data[0].userdata;
                const totalNumOfRecords = response.data.data[0].total_number_of_records;
